...
;( function( $, window, document, undefined )
    ...
    var offset_menu = $('header').outerHeight();
	...
	$(window).scroll(function(){
        ...
        ( $(this).scrollTop() > offset ) ? $('.main-footer').addClass('show-footer') : $('.main-footer').removeClass('show-footer');
...
$(function() {
    ...
    var options = [
        ...
        {selector: '#home-icons', offset: xpoffset, callback: 'Materialize.fadeInImage("#home-icons")'},
        {selector: '#home-products', offset: xpoffset, callback: 'Materialize.fadeInImage("#home-products")'}
        ];
